...
//添加新行
void FcltyTableWidget::AddRow(FACILITYINFO *Client)
{
	//判断是否已存在
	...
	listItem->setData(Qt::UserRole,QVariant::fromValue(Client));	
	listItem->setText(Client->ServiceName);
